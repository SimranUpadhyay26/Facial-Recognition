...
from gender_prediction import main
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        render = PhotoImage(file="./assets/home.png")
        ...
        button2.grid(row=2, column=0, ipady=3, ipadx=5)
...
class PageThree(tk.Frame):
    ...
    def capimg(self):
        ...
        messagebox.showinfo("INSTRUCTIONS", "We will Capture 50 pic of your Face.")
        x = start_capture(self.controller.active_name)
        self.controller.num_of_images = x
        self.numimglabel.config(text=str("Number of images captured = " + str(x)))

    def trainmodel(self):
        if self.controller.num_of_images < 50:
            messagebox.showerror(
                "ERROR", "No enough Data, Capture at least 50 images!"
            )
            return
...
class PageFive(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Gender Prediction", font="Helvetica 16 bold")
        label.grid(row=0, column=0, sticky="ew")
        button1 = tk.Button(
            self,
            text="Gender Prediction",
            command=self.on_gender_prediction,
            fg="#ffffff",
            bg="#263942",
        )
        button2 = tk.Button(
